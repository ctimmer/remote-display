...
# RemoteLinearGauge
#-------------------------------------------------------------------------------
class RemoteLinearGauge (RemoteArea) :
    def __init__ (self,
                  remote_display,
                  area_config) :
        super().__init__ (remote_display, area_config)
        self.vertical_gauge = True
        self.range_min = 0
        self.range_max = 100
        ...
        #
        if "verticalgauge" in area_config :
            self.vertical_gauge = area_config ["verticalgauge"]   # True/False
        if "horizontalgauge" in area_config :
            self.vertical_gauge = not area_config ["horizontalgauge"]   # True/False
    ...
    def update (self, **kwargs) :
        ...
        if self.current_value > self.range_max :
            ...
            self.current_value = self.range_min
        RemoteLinearGauge.reload (self, reload_all = False)
        #
    def reset (self) :
        #
        ...
        #
        self.current_value = self.range_min
        RemoteLinearGauge.reload (self, reload_all = True)
        #
